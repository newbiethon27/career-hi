...
-- 생성 시각: 2026-09-12T11:07:05.338Z
--
...
begin
  ...
  for r in
    select * from (values
  ('samsung-electronics', '삼성전자', '반도체·전자', '00126380', '{dev,data,pm,design,marketing}'::text[], 68, '관련 국내 커뮤니티(블라인드와 잡플래닛 등)의 커뮤니티 정보를 통해 추정', '2025', 15706, 13.7, 128881, 129480, 333605938, 300870903, 43601051, 32725961, 0),
  ('sk-hynix', 'SK하이닉스', '반도체', '00164779', '{dev,data,pm}'::text[], 78, '관련 국내 커뮤니티(블라인드와 잡플래닛 등)의 커뮤니티 정보를 통해 추정', '2025', 18500, 13.4, 34549, 32390, 97146675, 66192960, 47206319, 23467319, 1),
  ('naver', 'NAVER', '인터넷', '00266961', '{dev,data,pm,design,marketing}'::text[], 82, '관련 국내 커뮤니티(블라인드와 잡플래닛 등)의 커뮤니티 정보를 통해 추정', '2025', 14552, 7.7, 5047, 4583, 12035007, 10737719, 2208138, 1979263, 2),
  ('kakao', '카카오', '인터넷', '00258801', '{dev,data,pm,design,marketing}'::text[], 70, '관련 국내 커뮤니티(블라인드와 잡플래닛 등)의 커뮤니티 정보를 통해 추정', '2025', 10872, 6.3, 3922, 4028, 8099148, 7864033, 732037, 495278, 3),
  ('krafton', '크래프톤', '게임', '00760971', '{dev,data,pm,design,marketing}'::text[], 62, '관련 국내 커뮤니티(블라인드와 잡플래닛 등)의 커뮤니티 정보를 통해 추정', '2025', 12893, 3.2, 2118, 1903, 3326554, 2709774, 1054381, 1182488, 4),
  ('ncsoft', '엔씨소프트', '게임', '00261443', '{dev,data,pm,design,marketing}'::text[], 65, '관련 국내 커뮤니티(블라인드와 잡플래닛 등)의 커뮤니티 정보를 통해 추정', '2025', 11687, 7.5, 3262, 3832, 1506925, 1578123, 16078, -109215, 5),
  ('samsung-sds', '삼성SDS', 'IT서비스', '00126186', '{dev,data,pm,design}'::text[], 72, '관련 국내 커뮤니티(블라인드와 잡플래닛 등)의 커뮤니티 정보를 통해 추정', '2025', 13829, 17.2, 11219, 11387, 13929868, 13828232, 957103, 911097, 6),
  ('lg-electronics', 'LG전자', '전자', '00401731', '{dev,data,pm,design,marketing}'::text[], 76, '관련 국내 커뮤니티(블라인드와 잡플래닛 등)의 커뮤니티 정보를 통해 추정', '2025', 11759, 13.8, 34144, 35727, 89200882, 87728182, 2478392, 3419675, 7),
  ('hyundai-motor', '현대자동차', '자동차', '00164742', '{dev,data,pm,design,marketing}'::text[], 84, '관련 국내 커뮤니티(블라인드와 잡플래닛 등)의 커뮤니티 정보를 통해 추정', '2025', 13086, 15.8, 72598, 75137, 186254472, 175231153, 11467851, 14239592, 8),
  ('kt', 'KT', '통신', '00190321', '{dev,data,pm,marketing}'::text[], 88, '관련 국내 커뮤니티(블라인드와 잡플래닛 등)의 커뮤니티 정보를 통해 추정', '2025', 11860, 19.3, 14701, 16927, 28244161, 26431204, 2469133, 809471, 9)
